            ...
            <div id="about-us-navigation" class="nav-bg-blue">
                <div class="container-wrapper">
                    <ul class="inner-nav">
                        ...
                        <li><a href="corporate-integrity.php">Corporate Integrity</a></li>
                    </ul>
                </div>
                        ...
                        <table class="manage-incent-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Top performing employee turnover</td>
                                </tr>
                                <tr>
                                    <td>Labour management</td>
                                    <td>Social compliance audit</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div class="social-point bg-red overflow-hidden" data-aos="fade-right" data-aos-offset="300" data-aos-easing="linear">
                            <a href="corporate-governance.php">
                                ...
                                <div class="social-point-heading d-flex justify-content-between align-items-end">
                                    <h4>Corporate Governance</h4><i class="fas fa-angle-right"></i>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <div class="social-point bg-red overflow-hidden" data-aos="fade-left" data-aos-offset="300" data-aos-easing="linear">
                            <a href="corporate-integrity.php">
                                ...
                                <div class="social-point-heading d-flex justify-content-between align-items-end">
                                    <h4>Corporate Integrity</h4><i class="fas fa-angle-right"></i>
                                </div>
                            </a>
                        </div>
                    </div>
